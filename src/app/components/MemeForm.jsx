...
debugger;
		dispatch(this.props.actions.updateCaption, event.target.value);
	},
	...
	render: function () {
		...
		return (
			...
			<input id="assholeName" className="form-control" placeholder="i.e. Twatwaffles" type="text" onChange={this.handleChange.bind(this, 'assholeName')} value={generator.assholeName}/><br/>
